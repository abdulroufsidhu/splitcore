                                ...
                                child: RichText(
                                  text: TextSpan(
                                    ...
                                    children: [
                                      ...
                                      TextSpan(text: displayName(to, widget.me), style: const TextStyle(fontWeight: FontWeight.w700)),
                                    ],
                                  ),
                                ),
                              ),
                              MoneyText(t.amountCents, widget.group.currency, signed: false, size: 22, weight: FontWeight.w700),
                            ],
                          ),
